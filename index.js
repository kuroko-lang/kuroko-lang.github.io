...
var ASM_CONSTS = {
  8038: function() {window.setTimeout(function () { FS.syncfs(true,function (err) { if (err) { console.log(err); } }); },200);}
};
...
function hiwire_args_count(idval){ let jsobj = Hiwire.get_value(idval); return jsobj.length; }
function hiwire_args_get(idval,arg){ let jsobj = Hiwire.get_value(idval); return Hiwire.new_value(jsobj[arg]); }
...
function hiwire_get_error(){ return Hiwire.new_value(Hiwire.exception); }
...
function hiwire_krk_wrapper(id){ let krk_func = function() { let argsid = Hiwire.new_value(arguments); let resid = _krk_call_args(id, argsid); Hiwire.decref(argsid); if (resid != 0) { let output = Hiwire.pop_value(resid); return output; } else { let jsid = _krk_get_currentException(); let jsobj = Hiwire.pop_value(jsid); let error = new Error(jsobj[0]); error.__krkval__ = jsobj[1]; throw error; } }; krk_func.__krk__ = true; krk_func.__id__ = id; Hiwire.registry.register(krk_func, id); return Hiwire.new_value(krk_func); }
...
function hiwire_out_krk(idval){ let jsobj = Hiwire.get_value(idval); return jsobj.__id__; }
...
function obj_iskrk(idobj){ let jsobj = Hiwire.get_value(idobj); if (typeof jsobj === 'function') { return jsobj.hasOwnProperty('__krk__') && jsobj.hasOwnProperty('__id__'); } return 0; }
...
/** @type {function(...*):?} */
var _krk_cleanup = Module["_krk_cleanup"] = function() {
  return (_krk_cleanup = Module["_krk_cleanup"] = Module["asm"]["krk_cleanup"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _krk_call_args = Module["_krk_call_args"] = function() {
  return (_krk_call_args = Module["_krk_call_args"] = Module["asm"]["krk_call_args"]).apply(null, arguments);
};

/** @type {function(...*):?} */
var _krk_get_currentException = Module["_krk_get_currentException"] = function() {
  return (_krk_get_currentException = Module["_krk_get_currentException"] = Module["asm"]["krk_get_currentException"]).apply(null, arguments);
};
